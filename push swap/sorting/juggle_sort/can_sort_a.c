...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/21 13:16:59 by aiglesia          #+#    #+#             */
/*   Updated: 2021/06/21 13:17:00 by aiglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	current_set_size, int i)
{
	...
	bigest_number_b_tail = find_biggest_num_b(arrays,
			arrays->array_b_length - i - 1, arrays->array_b_length);
