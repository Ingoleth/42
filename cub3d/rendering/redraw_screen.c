...
/*   Updated: 2020/11/30 13:15:09 by aiglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int redraw_screen(cub3d *data)
{
    ...
    if (data->mlx_data.keys_pressed.enter)
    {
        ...
        mlx_put_image_to_window(mlx_data->mlx_ptr, mlx_data->win_ptr, mlx_data->health_bar.image->img, mlx_data->map->width + 2 * mlx_data->health_bar.pixel_size, 0);
    }
    return(0);
}